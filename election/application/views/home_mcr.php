...
<head>
    ...
    <script type="text/javascript">
        ...
        setInterval(function() {
            ...
            jQuery.ajax({
                type: "POST",
                url: "<?php echo base_url('/result/get_mcr_view'); ?>",
                dataType: 'json',
                ...
                success: function(res) {
                    ...
                    if (res)
                    {
                        ...
                        jQuery("div#mcr_view").html(res.username);
            ...
            jQuery.ajax({
                ...
                success: function(res) {
                    ...
                    if (res)
                    {
                        ...
                        jQuery("div#mcr_queue").html(res.username);
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="widget widget-default widget-item-icon" onclick="location.href='pages-address-book.html';">
                        ...
                        <div class="widget-data">
                            <div class="widget-int num-count">MCR</div>
                        ...
                        <div id="presenter_table_panel">
                            ...
                            <div class="panel panel-default" >
                                ...
                                <div class="panel-body panel-body-table">
                                    ...
                                    <div class="table-responsive" id="mcr_queue">
                        ...
                        <div id="presenter_table_panel">
                            ...
                            <div class="panel panel-default" >
                                ...
                                <div class="panel-body panel-body-table">
                                    ...
                                    <div class="table-responsive" id="mcr_view">
